<?php
	...
	function printPost($accountName, $accountProfil, $postContent, $postType, $postSpot, $postLike, $postDescription, $postDate) {
			...
			<div class="post">
				<div class="post-header">
					...
					<div class="post-header-information">
						<p class="post-publisher">' . $accountName . ' • '.$postDate.'</p>
							...
							<div class="post-popup-comment">
								<div class="post-popup-header">
									...
									<div class="post-popup-header-information">
										<p class="post-popup-publisher">' . $accountName . ' • '.$postDate.'</p>
		...
		printPost("DidonCode","images/r.jpg","images/Minecraft.jpg","image","Nevers", "265", "Premier post !", "2j");
		printPost("Killian","images/civilisation.jpg","images/NyanCat.mp4","video","Nevers", "12","NyanCat !", "4j");
?>